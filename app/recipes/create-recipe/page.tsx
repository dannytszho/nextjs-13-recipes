export default function CreateRecipePage() {
    return (
        <div className="max-w-2xl mr-2 bg-white p-16">
            <form className="p-8 border justify-center top-52 md:left-48 left-6 right-6 md:right-48 absolute bg-white">
                <div className="grid grid-cols-1 divide-y gap-6 w-full">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            className="bg-blue-50 border border-gray-300 text-gray-900 sm:text-sm font-light rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 mb-6 mt-2"
                        >
                    ...
                    <div id="post-ingredients-group" className="mb-4">
                        ...
                        <div id="post-ingredients-inputs" className="mb-2">
                            <input
                                type="text"
                                className="bg-blue-50 border border-gray-300 text-gray-900 sm:text-sm font-light rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 mb-2"
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            className="bg-gray-50 border h-20 border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 mt-2 mb-4 align-top"
